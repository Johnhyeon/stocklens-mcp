...
국내·미국 분봉을 쓰려면 한국투자증권 Open API 를 연결합니다.

1. https://apiportal.koreainvestment.com 에서 App Key·App Secret 발급 (시세 조회용)
2. LeetKit Manager 를 열고 StockLens 카드의 [증권사 연결] 클릭
3. 실전(기본) 선택 후 App Key·App Secret 입력, [연결 시험 후 저장]
...
- 연결 해제는 두 단계입니다
  ...
  - **한국투자증권 연결을 모두 해제**: 모든 키와 KIS 분봉 캐시 삭제.
